...
1. **课程影片**：李宏毅，〈解剖小龙虾 — 以 OpenClaw 为例介绍 AI Agent 的运作原理〉，ML 2026 Spring，[YouTube](https://youtu.be/2rcJdFuNbZQ)
2. **课前背景**：〈【生成式人工智慧与机器学习导论 2025】第1讲：一堂课搞懂生成式人工智慧的原理〉，[YouTube](https://youtu.be/TigfpYPJk1s)
3. **课程讲义**：[intro.pdf](https://speech.ee.ntu.edu.tw/~hylee/ml/ml2026-course-data/intro.pdf)，李宏毅，NTU ML 2026 Spring
4. **OpenClaw 专案**：[openclaw.ai](https://openclaw.ai)
5. **ClawHub（SKILL 市集）**：[clawhub.ai](https://clawhub.ai/)
6. **SKILL 安全风险**：Koi Security, [*ClawHavoc: 341 Malicious ClawedBot Skills Found by the Bot They Were Targeting*](https://www.koi.ai/blog/clawhavoc-341-malicious-clawedbot-skills-found-by-the-bot-they-were-targeting), 2026
