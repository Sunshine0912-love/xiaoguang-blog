...
## 和 LLMLingua、Selective Context 的关系
...
[1] Tejas Chopra, [*Headroom GitHub Repository*](https://github.com/chopratejas/headroom), GitHub, 2026.

[2] Headroom Docs, [*Benchmarks and Methodology*](https://headroom-docs.vercel.app/docs/benchmarks), 2026.

[3] Huiqiang Jiang et al., [*LLMLingua-2: Data Distillation for Efficient and Faithful Task-Agnostic Prompt Compression*](https://arxiv.org/abs/2403.12968), arXiv, 2024.

[4] Ghalandari et al., [*Selective Context: Efficiently Compressing Contexts for LLMs*](https://arxiv.org/abs/2304.12102), arXiv, 2023.

[5] Model Context Protocol, [*Introduction*](https://modelcontextprotocol.io/introduction), official documentation, 2025.
